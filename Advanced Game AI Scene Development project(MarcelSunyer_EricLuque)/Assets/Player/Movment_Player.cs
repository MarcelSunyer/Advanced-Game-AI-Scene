...
public class PlayerMovement : MonoBehaviour
{
    ...
    // Se llama una vez cuando se inicializa el objeto
    void Start()
    {
        rb = GetComponent<Rigidbody>(); // Obtener el componente Rigidbody
    }

    // FixedUpdate se llama en intervalos fijos de tiempo
    void Update()
    {
        ...
        rb.MovePosition(transform.position + moveAmount); // Mueve al jugador utilizando el Rigidbody
